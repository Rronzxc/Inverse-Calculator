...
Main_layout = [
    ...
    sg.Push(), sg.Image('Cartesian Image.gif', key='_IMAGE_'), sg.Push()],
...
def Inverse_Kinematics_window():
    sg.theme('DarkBlue')
    EXCEL_FILE = 'Cartesian Manipulator Design Data IK.xlsx'
...
while True:
    ...
    window.Element('_IMAGE_').UpdateAnimation('Cartesian Image.gif', time_between_frames=50)
